from tools.create.create_user import generate_random_user_data, create_user
from tools.create.create_category import random_category, create_categories
from tools.create.sub_category import sub_category_data, create_sub_categories
from tools.create.create_product import products, create_product
from tools.create.create_order import create_order, order
from tools.export.export_order_data import *
from tools.export.export_user_data import *
from tools.export.export_category_data import *
from tools.export.export_sub_category import *
from tools.export.export_product_data import *
...
if action == str(1):
    ...
    if __name__ == "__main__":
        ...
        export_sub_category_data(data, sub_category_excel_file_path, sub_category_csv_file_path)
